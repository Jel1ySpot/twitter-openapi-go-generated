...
func (r ApiGetProfileSpotlightsQueryRequest) Features(features map[string]interface{}) ApiGetProfileSpotlightsQueryRequest {
	r.features = &features
	return r
}

func (r ApiGetProfileSpotlightsQueryRequest) Execute() (*GetProfileSpotlightsQuery200Response, *http.Response, error) {
	return r.ApiService.GetProfileSpotlightsQueryExecute(r)
}
...
func (a *DefaultAPIService) GetProfileSpotlightsQueryExecute(r ApiGetProfileSpotlightsQueryRequest) (*GetProfileSpotlightsQuery200Response, *http.Response, error) {
	...
	localVarPath := localBasePath + "/graphql/{pathQueryId}/ProfileSpotlightsQuery"
...
func (r ApiGetTweetResultByRestIdRequest) Execute() (*GetTweetResultByRestId200Response, *http.Response, error) {
	return r.ApiService.GetTweetResultByRestIdExecute(r)
}
...
func (a *DefaultAPIService) GetTweetResultByRestIdExecute(r ApiGetTweetResultByRestIdRequest) (*GetTweetResultByRestId200Response, *http.Response, error) {
	...
	localVarPath := localBasePath + "/graphql/{pathQueryId}/TweetResultByRestId"
	localVarPath = strings.Replace(localVarPath, "{"+"pathQueryId"+"}", url.PathEscape(parameterValueToString(r.pathQueryId, "pathQueryId")), -1)
