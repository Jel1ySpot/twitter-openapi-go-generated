...
func (r ApiGetUserByRestIdRequest) Execute() (*GetUserByRestId200Response, *http.Response, error) {
	return r.ApiService.GetUserByRestIdExecute(r)
}
...
func (a *UserAPIService) GetUserByRestIdExecute(r ApiGetUserByRestIdRequest) (*GetUserByRestId200Response, *http.Response, error) {
	...
	localVarPath := localBasePath + "/graphql/{pathQueryId}/UserByRestId"
...
func (r ApiGetUserByScreenNameRequest) Execute() (*GetUserByRestId200Response, *http.Response, error) {
	return r.ApiService.GetUserByScreenNameExecute(r)
}
...
func (a *UserAPIService) GetUserByScreenNameExecute(r ApiGetUserByScreenNameRequest) (*GetUserByRestId200Response, *http.Response, error) {
	...
	localVarPath := localBasePath + "/graphql/{pathQueryId}/UserByScreenName"
	localVarPath = strings.Replace(localVarPath, "{"+"pathQueryId"+"}", url.PathEscape(parameterValueToString(r.pathQueryId, "pathQueryId")), -1)
